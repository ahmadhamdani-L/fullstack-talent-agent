...
router.post(
  "/order",
  IndexCtrl.TalentCartCtrl.findOne1,
...
router.post(
  "/chartLine",
  IndexCtrl.TalentCartCtrl.findCreateCart,
  IndexCtrl.LiteItemCtrl.createlineItem
);

router.get("/findAllOpen/:id",IndexCtrl.TalentCartCtrl.findAllOpen)
